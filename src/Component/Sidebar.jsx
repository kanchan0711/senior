...
const Sidebar = ({children}) => {
    ...
    return (
        // <div style={{ borderRadius:"50px"}}className='border m-3 rounded-9 justify-content-center'>
        <div className="side m-3">
           <div style={{width: isOpen ? "200px" : "50px"}} className="sidebar">
               <div className="top_section">
                   <h1 style={{display: isOpen ? "block" : "none"}} className="logo m-4">Logo</h1>
                   <div style={{marginLeft: isOpen ? "50px" : "0px"}} className="bars">
                       <FaBars onClick={toggle}/>
                   </div>
               </div>
